...
5. 风险详情
   ...
   - 如果存在 `risk.suggestedCode`，必须在“建议”字段内部展示“修改前 / 修改后”代码对比。
   - 风险建议的“修改前”优先使用 `risk.codeSnippet`，“修改后”使用 `risk.suggestedCode`。
...
6. Review 建议
   ...
   - 显示可复制的 Review 评论正文
   - 如果存在 `suggestion.currentCode` 或 `suggestion.suggestedCode`，在评论正文下方展示“修改前 / 修改后”代码对比
...
7. 风险展示要求：
   ...
   - 风险详情和 Review 建议中的代码建议都要尽量使用“修改前 / 修改后”对比，而不是只展示修改后的代码。
